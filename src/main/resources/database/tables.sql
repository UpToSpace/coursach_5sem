...
create table userroles (
    id number(10) GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCYCLE ORDER),
    name varchar2(50),
...
create table categories (
    id number(10) GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCYCLE ORDER),
    name varchar2(100),
    info varchar2(2000),
...
create table collections (
    ...
    constraint users_fk foreign key (email) references users(email) on delete cascade
);
...
create table collection_pictures (
    ...
    constraint collection_fk foreign key (collection_id) references collections(id) on delete cascade,
